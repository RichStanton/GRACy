		...
		def performAssembly():
			...
			while True:
				...
				if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_1_15001_f.txt | "+installationDirectory+"src/conda/bin/bcftools consensus output_filtered.vcf.gz > finalScaffold_1_15001_f.txt_con.fasta 2>/dev/null")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt | "+installationDirectory+"src/conda/bin/bcftools consensus output_filtered.vcf.gz > finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt_con.fasta 2>/dev/null")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt | "+installationDirectory+"src/conda/bin/bcftools consensus output_filtered.vcf.gz > finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt_con.fasta 2>/dev/null")
